...
2. **URL Source:** Use this when the asset content must be downloaded by Direkt from an external URL.
...
## URL Source
Instead of supplying the file contents directly, you can specify a URL that Direkt will download the asset content from. 
