...
---
# API Overview
After an asset is stored, it can be fetched. Direkt offers powerful options to fetch your asset in a variety of ways using
query modifiers.
  ...
  "variants": [
    {
      ...
      "storeKey": "d905170f-defd-47e4-b606-d01993ba7b42", // Generated by Direkt
      "imageAttributes": {
        "height": 100,
        "width": 200,
        "mimeType": "image/jpeg"
