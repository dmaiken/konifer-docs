...
Using Postgres for information, metadata, and a wide variety of options for object storage, you own your data. You maintain control
over asset manipulation, and expensive transformations are generated on your own hardware, exactly when and how you
specify.
...
- Labels and tags with the ability to search by labels
