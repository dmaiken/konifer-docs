...
The Bruno requests in this guide use the asset path `users/123abc/profile-pictures`. In the Cloudflare dashboard, confirm that
an object now appears in the `profile-pictures` bucket.
