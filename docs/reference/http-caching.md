...
the proper
usage of [`Cache-Control` header directives](https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Headers/Cache-Control).
...
scope
of this document. See the [MDN ETag header documentation](https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Headers/ETag)
